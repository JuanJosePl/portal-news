...
const Category = () => {
  ...
  useEffect(() => {
    const fetchArticles = async () => {
      ...
      const filteredArticles = mockArticles.filter(
        article => article.category.toLowerCase() === id.toLowerCase()
      );
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-8 text-highlight font-headline">{id.charAt(0).toUpperCase() + id.slice(1)}</h1>
